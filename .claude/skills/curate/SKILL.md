...
- **존댓말 기본** — "~해요", "~더라고요", "~거든요", "~해보세요"
- **젠틀맨 어조** — 차분하고 신뢰감 있게, 과장 없이 담백하게
- **사람 냄새** — 본인 경험처럼 ("써봤는데", "고민했는데", "진짜 달라지더라고요")
- **ㅋㅋ, ㅠㅠ, 이모지 안 씀** — 클라스 있는 톤 유지
- **"사세요", "강추" 같은 판매 어투 절대 금지**
- 예시: "자취 3년차인데 이건 진짜 삶이 달라졌어요. 처음엔 고민했는데, 쓰고 나니까 왜 진작 안 샀나 싶더라고요."
...
- 본문: 1~2줄, 존댓말 + 젠틀맨 톤
- **링크 없음. 댓글에도 링크 없음.**
- 예시: "자취 3년차가 직접 써보고 고른 가전 3가지입니다. 하나라도 도움이 되면 좋겠어요."

## 결과 저장

```
C:/partners/contents/threads/{날짜}_{유형}_{주제키워드}/
├── text.md
├── slide1-hook.png
├── slide2-item1.png
├── slide3-item2.png
